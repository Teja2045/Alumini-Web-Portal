...
<div style="padding: 100px 0px">
  <div class="container-fluid">
    ...
    <% 
  if(session.getAttribute("forgot").equals("false")) 
  {	   
  %>
  <div class = "alert alert-danger" role="alert" >
  <h5 style="text-align:center; color:red">We could't find you. Please contact the admin!!!</h5>
  </div>
      ...
      <div class="col-6" style="background-color: #eff5f5">
        ...
        <form action="question.jsp" method="post">
          <div class="row">
            ...
            <div class="col-8">
              <div class="row">
                <label class="form-label"><h6>Enter your ID</h6></label>
                <input class="form-control" type="text" name="U_id" placeholder="enter your id number..." required>
              </div>
