...
<html lang="en">
  <head>
    ...
    <title>REGISTRATION SUCCESSFUL | ALUMNI | CSE dept</title>
  </head>
  <body>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            ...
            <li><a class="index.jsp" href="#">Alumni</a></li>
          </ul>
        </li>
      </ul>
      <% 
    ...
    <div class="row">
      ...
      <div class="col-10">
        ...
        <div class="alert alert-success d-flex align-items-center" role="alert">
          ...
          <div>
            <h6>Congratulations!</h6> Your Registration is Successful... <br> Now You are a part of this Alumni Portal from now on...!
          </div>
        </div>
        <div><center><button class="btn btn-primary" type="submit"><a href="index.jsp" style="color: white; text-decoration: none;">Return to Alumni Portal</a></button></center></div>
      </div>
      <div class="col">
