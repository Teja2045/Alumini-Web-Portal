...
<div style="padding: 100px 0px">
  <div class="container-fluid"> <% String str = request.getParameter("id"); %>
    ...
    <div class="row">
      ...
      <div class="col-10" style="background: #eff5f5">
        <form action="form?U_id=<%=str%>" method="post" enctype = "multipart/form-data">
          <div class="row">
            <center>
            <div class="col-6">
              <label class="form-label">Profile Image</label>
              <input type="file" class="form-control" name = "image" placeholder = "select your profile picture" required>
            </div>
          </center>
          </div><br>
          <div class="row">
          ...
          <div class="row">
            <div class="col-6">
              <input class="form-control" type="text" name="id" value="<%=str%>" required disabled>
            </div>
            <div class="col-6">
              <input class="form-control" type="Password" name="U_pswd" placeholder="Enter your password" required>
            </div>
          </div>
          <br>
           <div class="row">
          ...
          <div class="row">
           	<div class="col-6">
              <input class="form-control" type="text" name="q1" placeholder="enter the question..." required>
            </div>  
            <div class="col-6">
              <input class="form-control" type="text" name="s1" placeholder="enter the solution" required>
            </div>
          </div> <br> 
          <div class="row">
            <div class="col-6">
          ...
          <div class="row">
           	<div class="col-6">
              <input class="form-control" type="text" name="q2" placeholder="enter the question..." required>
            </div>  
            <div class="col-6">
              <input class="form-control" type="text" name="s2" placeholder="enter the solution" required>
            </div>
          </div> <br>
          <div class="row">
            <div class="col-6">
          ...
          <div class="row">
           	<div class="col-6">
              <input class="form-control" type="text" name="q3" placeholder="enter the question..." required>
            </div>  
            <div class="col-6">
              <input class="form-control" type="text" name="s3" placeholder="enter the solution" required>
            </div>
          </div>
          <br>
          <br>
          ...
          <div class="row">
            ...
            <div class="col-6">
              <input class="form-control" type="tel" name="Mob_num" pattern="[0-9][0-9]{9}" placeholder="Enter your Mobile Number" required> 
            </div>
          </div>
          <br>
          <div class="row">
          ...
          <div class="row">
            <div class="col-6">
              <input class="form-control" name="ds" type="text" placeholder="Enter your Designation">
            </div>
            <div class="col-6">
              <input class="form-control" name="pk" type="text" placeholder="Enter your per annum package in number">
            </div>
          </div>
          <br>
          <div class="row">
          ...
          <div class="row">
            <div class="col-6">
              ...
              <input class="form-control" name="lk" type="url" placeholder="Paste your Linked-In Profile link">
            </div>
            <div class="col-6">
              <label class="form-label">Twitter</label>
              <input class="form-control" type="url" name="tr" placeholder="Paste your Twitter profile link">
            </div>
          </div>
          <div class="row">
            <div class="col-6">
              <label class="form-label">Instagram</label>
              <input class="form-control" type="url" name="ins"placeholder="Paste your Instagram Profile link">
            </div>
            <div class="col-6">
              <label class="form-label">Facebook</label>
              <input class="form-control" type="url" name="fb"placeholder="Paste your Facebook profile link">
            </div>
          </div>
          <br><br>
          <div class="row">
