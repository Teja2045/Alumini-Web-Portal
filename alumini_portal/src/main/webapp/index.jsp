...
<div style = "padding: 50px 0px 100px 0px">
  ...
  if(!str.equals("false")&&!str.equals("admin")){
  %>
    <button class="btn btn-primary" ><a href="update.jsp" style="text-decoration: none; color: white;">Update Profile</a></button> <%} else{%>
  ...
  {	   %>
  	<div class="row container">
  		<div class="w-100"></div>
  		<div class="col-md-2 col-3"><a href="view1.jsp?company=Google"><center><img src="companies/google.jpg" height="50px" width="50px"></a><br><label>Google</label><br><br><br></center></div><br>
  		<div class="col-md-2 col-3"><a href="view1.jsp?company=Apple"><center><img src="companies/apple.png" height="50px" width="50px"></a><br><label>Apple</label><br><br><br></center></div><br>
  		<div class="col-md-2 col-3"><a href="view1.jsp?company=Microsoft"><center><img src="companies/microsoft.jpg" height="50px" width="50px"></a><br><label>Microsoft</label><br><br><br></center></div><br>
  		<div class="col-md-2 col-3"><a href="view1.jsp?company=Facebook"><center><img src="companies/facebook.png" height="50px" width="50px"></a><br><label>Facebook</label><br><br><br></center></div><br>
  		<div class="col-md-2 col-3"><a href="view1.jsp?company=TCS"><center><img src="companies/tcs.png" height="50px" width="50px"></a><br><label>TCS</label></center></div><br>
  		<div class="col-md-2 col-3"><a href="view1.jsp?company=Thoughtworks"><center><img src="companies/thoughtworks.png" height="50px" width="50px"></a><br><label>Thoughtworks</label><br><br><br></center></div>
  		<div class="col-md-2 col-3"><a href="view1.jsp?company=Infosys"><center><img src="companies/infosys.jpg" height="50px" width="50px"></a><br><label>Infosys</label><br><br><br></center></div>
  		<div class="col-md-2 col-3"><a href="view1.jsp?company=Outplay"><center><img src="companies/outplay.jpg" height="50px" width="50px"></a><br><label>Outplay</label><br><br><br></center></div>
  		<div class="col-md-2 col-3"><a href="view1.jsp?company=Wipro"><center><img src="companies/wipro.png" height="50px" width="50px"></a><br><label>Wipro</label><br><br><br></center></div>
  		<div class="col-md-2 col-3"><a href="view1.jsp?company=Vasarlabs"><center><img src="companies/vasarlabs.jpg" height="50px" width="50px"></a><br><label>Vasarlabs</label><br><br><br></center></div>
  		<div class="col-md-2 col-3"><a href="view1.jsp?company=Epam"><center><img src="companies/epam.png" height="50px" width="50px"></a><br><label>Epam</label><br><br><br></center></div>
  		<div class="col-md-2 col-3"><a href="view1.jsp?company=Others"><center><img src="download.png" height="50px" width="50px"></a><br><label>Others</label><br><br><br></center></div>
	</div>
  <%} %>
